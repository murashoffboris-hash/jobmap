...
- **Перед блокировкой задачи на review — ОБЯЗАТЕЛЬНЫЙ `git push`** (код в scratch-воркспейсе удаляется безвозвратно, см. [[10_Известные проблемы/Потеря кода в scratch-workspace]])
