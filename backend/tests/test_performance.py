...
class TestCacheKey:
    ...
    def test_basic_key(self):
        key = _list_cache_key(1, 20, None, None, 10.0, None, None, None)
        assert key == "vacancy_list:1:20:_:_:10.0:_:_:_"

    def test_with_coords(self):
        key = _list_cache_key(1, 20, 53.9, 27.5667, 10.0, None, None, None)
        assert key == "vacancy_list:1:20:53.9000:27.5667:10.0:_:_:_"

    def test_with_search(self):
        key = _list_cache_key(2, 50, None, None, 10.0, "driver", "Minsk", 5)
        assert key == "vacancy_list:2:50:_:_:10.0:driver:Minsk:5"

    def test_different_pages_different_keys(self):
        k1 = _list_cache_key(1, 20, None, None, 10.0, None, None, None)
        k2 = _list_cache_key(2, 20, None, None, 10.0, None, None, None)
        assert k1 != k2
